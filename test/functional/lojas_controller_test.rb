...
class LojasControllerTest < ActionController::TestCase
  ...
  test "should create loja" do
    assert_difference('Loja.count') do
      post :create, loja: { detalhes: @loja.detalhes, gmaps: @loja.gmaps, latitude: @loja.latitude, longitude: @loja.longitude, morada: @loja.morada, nome: @loja.nome }
    end
  ...
  test "should update loja" do
    put :update, id: @loja, loja: { detalhes: @loja.detalhes, gmaps: @loja.gmaps, latitude: @loja.latitude, longitude: @loja.longitude, morada: @loja.morada, nome: @loja.nome }
    assert_redirected_to loja_path(assigns(:loja))
  end
